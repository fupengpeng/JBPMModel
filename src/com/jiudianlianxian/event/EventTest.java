...
public class EventTest {
	...
	// 读取核心配置文件，并创建表
		...
		public void deploy() {
			...
			// 加载流程定义文档
			deployment.addResourceFromClasspath("com/jiudianlianxian/event/event.jpdl.xml");
			deployment.addResourceFromClasspath("com/jiudianlianxian/event/event.png");
